...
@section('content')
    <form id="gameForm" action={{ route('data-game-add') }} class="p-0 lg:px-8 flex flex-col gap-8" method="POST">
        ...
        <div class="flex flex-col">
            ...
            <div class="w-full @error('game_full_description') border border-[#C15755] @enderror"><textarea name="game_full_description" id="game_full_description" class="full w-full h-64 rounded-sm field-bg p-3 text-white ">{{ old('game_full_description') }}</textarea></div>
