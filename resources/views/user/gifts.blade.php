...
@section('content')
    <div class="container min-w-full">
        <div class="profile-top w-full -mt-8">
            ...
            <div class="text-2xl font-light mb-1 text-white cursor-pointer" onclick="navigate('/profile/{{Auth::user()->unique_code}}')">{{Auth::user()->nickname}} <span class="text-xs mx-1 text-[#828282]">>></span> <span class="text-sm">Received Gifts</span></div>
        </div>
